...
class Person(models.Model):
    ...
    _search_filters_mapping = {
        ...
        'state': '',
        'hospital': '__icontains',
        'cemetery': '__icontains',
        'born_region': '__icontains',
        'born_address': '__icontains',
        'conscription_place': '__icontains',
        'military_unit': '__icontains',
        'rank': '__icontains',
        'position': '__icontains',
        'address': '__icontains',
        'relatives': '__icontains',
        ...
        'place_of_captivity': '__icontains',
        'camp': '__icontains',
        'camp_number': '__icontains',
        'lost_date': '__icontains',
        'field_post': '__icontains',
        'notes': '__icontains',
    }
